...
Branch-and-bound and backtracking are methods to design algorithms to
solve optimization problems. Algorithms based on the methods act by repeatedly splitting
...
enough solution exists compared to the current best candidate. The goal of the
...
implement just the problem-specific parts of their algorithm. For the
library implementation, the Rust programming language was selected,
